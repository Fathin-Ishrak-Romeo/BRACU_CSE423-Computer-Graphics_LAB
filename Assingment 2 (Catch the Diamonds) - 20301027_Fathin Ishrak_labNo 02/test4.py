...
# Catcher settings
catcher_width = 80  # Increased catcher size
catcher_height = 20
catcher_speed = 5
catcher_color = WHITE
...
def draw_catcher_plate(x, y, color):
    pygame.draw.line(screen, color, (x + 10, y + catcher_height), (x + catcher_width - 10, y + catcher_height), 2)  # Bottom line
    pygame.draw.line(screen, color, (x + 10, y + catcher_height), (x, y), 2)  # Left diagonal
    pygame.draw.line(screen, color, (x + catcher_width - 10, y + catcher_height), (x + catcher_width, y), 2)  # Right diagonal
...
while True:
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.MOUSEBUTTONDOWN:
            ...
            if 150 <= mouse_x <= 200 and 10 <= mouse_y <= 50:
                paused = not paused
            # Exit button (red, right)
            if 310 <= mouse_x <= 350 and 10 <= mouse_y <= 50:
    ...
    # Draw UI buttons with reduced size
    draw_left_arrow(10, 10, 20, TEAL)  # Left arrow button (restart)
    draw_play_pause(150, 10, 20, AMBER, paused)  # Play/pause button
    draw_cross(310, 10, 20, RED)  # Cross button (exit)
