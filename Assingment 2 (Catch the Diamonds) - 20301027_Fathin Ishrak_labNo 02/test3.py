...
# Function to draw the catcher using mid-point lines
def draw_catcher(x, y, color):
    pygame.draw.line(screen, color, (x, y), (x + catcher_width, y), 2)
    pygame.draw.line(screen, color, (x + catcher_width, y), (x + catcher_width, y + catcher_height), 2)
    pygame.draw.line(screen, color, (x + catcher_width, y + catcher_height), (x, y + catcher_height), 2)
    pygame.draw.line(screen, color, (x, y + catcher_height), (x, y), 2)
...
while True:
    ...
    # Draw UI buttons using midpoint line algorithm
    draw_left_arrow(10, 10, 50, TEAL)  # Left arrow button (restart)
    draw_play_pause(160, 10, 50, AMBER, paused)  # Play/pause button
    draw_cross(310, 10, 50, RED)  # Cross button (exit)
